  ...
  const scripts: ScriptTemplate[] = [
    {
      ...
      message: "Olá! Seja muito bem-vindo(a) à Solution Place. Sou Viviane, especialista em segurança automotiva. Para que eu possa te auxiliar da melhor forma possível, qual é o modelo e o ano do seu veículo?"
    },
    {
    ...
    <div className="min-h-screen bg-background text-foreground relative overflow-x-hidden font-body pb-24">
      ...
      <div className="container max-w-6xl mx-auto px-6 pt-12 print-container">
        ...
        >
          ...
          <div className="flex flex-col md:grid md:grid-cols-12 gap-8 items-start bg-card/30 border border-white/5 p-4 md:p-8 rounded-xl backdrop-blur-sm print-card">
            
            {/* Visualização de Conversas Etiquetadas */}
            <div className="w-full md:col-span-8 space-y-4">
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-[10px] md:text-xs font-bold text-muted-foreground uppercase tracking-widest">Exemplo de Visualização no WhatsApp Business</h3>
              </div>

              <div className="space-y-3">
                {/* Contato 1: Sem Etiqueta */}
                <div className="bg-white/5 border border-white/10 rounded-xl p-3 md:p-4 flex items-center gap-3 md:gap-4 transition-all hover:bg-white/10">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-blue-600 flex items-center justify-center text-white font-bold text-base md:text-lg shrink-0">
                    A
                  </div>
                  ...
                  <div className="shrink-0 flex flex-col items-end gap-1.5 md:gap-2">
                    ...
                    <CheckCheck size={12} className="text-muted-foreground/30 md:w-[14px] md:h-[14px]" />
                  </div>
                </div>

                {/* Contato 2: Novo cliente */}
                <div className="bg-white/5 border border-white/10 rounded-xl p-3 md:p-4 flex items-center gap-3 md:gap-4 transition-all hover:bg-white/10">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-amber-600 flex items-center justify-center text-white font-bold text-base md:text-lg shrink-0">
                    H
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="flex justify-between items-start mb-0.5 md:mb-1">
                  ...
                  <div className="shrink-0 flex flex-col items-end gap-1.5 md:gap-2">
                    ...
                    <div className="flex items-center gap-1">
                      <CheckCheck size={12} className="text-primary md:w-[14px] md:h-[14px]" />
                    </div>
                  </div>
                </div>
                ...
                {/* Contato 3: Pago */}
                <div className="bg-white/5 border border-white/10 rounded-xl p-3 md:p-4 flex items-center gap-3 md:gap-4 transition-all hover:bg-white/10">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-emerald-600 flex items-center justify-center text-white font-bold text-base md:text-lg shrink-0">
                    R
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="flex justify-between items-start mb-0.5 md:mb-1">
                  ...
                  <div className="shrink-0 flex flex-col items-end gap-1.5 md:gap-2">
                    ...
                    <CheckCheck size={12} className="text-emerald-400 md:w-[14px] md:h-[14px]" />
                  </div>
                </div>
              </div>
            ...
            <div className="w-full md:col-span-4 space-y-6">
